...
class TimelineImages extends StatelessWidget with TimelineImageBuilder {
  ...
  Widget _buildContent(BuildContext context) => ListView.builder(
      ...
      itemBuilder: (_, index) =>
          images.elementAt(index).let((image) => Container(
                width: cellSize.width,
                child: _buildItem(image, context),
              )));

  Column _buildItem(TimelineImageModel image, BuildContext context) => Column(
      mainAxisAlignment: MainAxisAlignment.center,
      crossAxisAlignment: CrossAxisAlignment.center,
      children: buildImageCellWidgets(
        image.imageName,
        context: context,
        width: cellSize.width,
        ...
        actions: [],
        onTap: () {
          BlocProvider.of<DailyTimelineBloc>(context).add(TapDailyTimelineCell(
